    ...
    <div>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Label ID="Label6" runat="server" BackColor="White" ForeColor="Maroon" Text="ĐĂNG KÍ PHÒNG"></asp:Label>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:TextBox ID="txtCq" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style3">&nbsp;</td>
                <td class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Label ID="lblThongbao" runat="server" Text="Lable"></asp:Label>
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
